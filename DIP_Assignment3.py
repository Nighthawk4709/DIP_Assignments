...
#Aim: Create two images one with a white circle another with a white rentangle at center 
# After that perform all logical operations on these images and display the output images. 
